...
354	09.12.2023	Schwitzbad unter Decke, Schrank Bettenlage geholt, Flora Whatsapp	Bank, Nacken, Kettlebell Rücken	Das Haus im Wald	
...
SELECT pg_catalog.setval('public.journalnew_key_seq', 355, true);
