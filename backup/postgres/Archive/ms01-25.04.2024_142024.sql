...
CREATE TABLE public.blutdruck (
    ...
    kommentar character varying(20),
...
01.04.2024	Dr. Bloch	28.03.2024		Dr. Bloch	Checkup 28.03.2024; 18.04.2024	336,94	 	 	158
30.03.2023	Dr. Huber	30.03.2023		Dr. Huber	Zahnreinigung	261,27	17.04.2023	261,27	139
	Dr. Bloch	18.04.2024	18.04.2024	Dr. Bloch	EKG, Laborwerte besprechen		 	 	160
15.04.2024	Synlad Labor	28.03.2024			Labor	57,56	 	 	159
19.04.2024	Rathaus Apotheke		18.04.2024	Dr. Bloch	HCT Rezept	12,48	 	 	161
 	 	 	 	 	 	 			167
 	 	 	 	 	 	 			168
...
477	11.04.2024	BMC in FFM, Flore gesprochen, Gambach nach Köln gefahren			
478	12.04.2024	Mit Roseline in der Stadt		Wenn die Zeit gekommen ist	
479	13.04.2024	Aachener Weiher Biergarten gegessen, CB in linkein gemeldet		Wenn die Zeit gekommen ist	
...
SELECT pg_catalog.setval('public.blutdruck_key_column_seq', 112, true);
...
SELECT pg_catalog.setval('public.dkv_id_seq', 168, true);
...
SELECT pg_catalog.setval('public.journalnew_key_seq', 488, true);
...
SELECT pg_catalog.setval('public.reisekosten_key_seq', 21, true);
