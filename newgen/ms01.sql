...
ALTER TABLE public.flfbs_km_id_seq OWNER TO postgres;
...
ALTER TABLE public.flhtkl_km_id_seq OWNER TO postgres;
...
ALTER TABLE public.flstfi_km_id_seq OWNER TO postgres;
...
ALTER TABLE public.toyota_km_id_seq OWNER TO postgres;
...
ALTER TABLE public.vrscdx_km_id_seq OWNER TO postgres;
...
54	30. Jun 24			42516	KM Stand	01. Jun 24	30. Jun 24	97	42613
\.
...
41	31. Jul 24				KM Stand	01. Jul 24	31. Jul 24		
40	30. Jun 24			16459	KM Stand	01. Jun 24	30. Jun 24		
\.
...
SELECT pg_catalog.setval('public.blutdruck_key_column_seq', 175, true);
...
SELECT pg_catalog.setval('public.dkv_id_seq', 190, true);
...
SELECT pg_catalog.setval('public.flhtkl_km_id_seq', 55, true);
...
SELECT pg_catalog.setval('public.flstfi_km_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.journalnew_key_seq', 6174, true);
...
SELECT pg_catalog.setval('public.vrscdx_km_id_seq', 41, true);
